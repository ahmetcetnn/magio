    ...
    <div>
      <section className="rounded-xl bg-white  px-2">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-xs text-gray-500" aria-label="More options">…</button>
        </div>
        <div>
          {loading ? (
            <>
            ...
            <div className="relative  pb-16">
              {cards[0] && (
                <div className="relative w-full rounded-2xl overflow-hidden text-white  z-0" style={{ transform: 'scaleY(0.75)', transformOrigin: 'top left' }}>
                  <img src="/icons/BG.png" alt="Card" className="block w-full h-auto" />
                  <div className="absolute inset-0 p-5 flex flex-col">
                    <div className="flex items-center justify-between">
                      ...
                      {/* Wi‑Fi moved to the chip row below */}
                    </div>
                    {/* Chip and Wi‑Fi on the same row, vertically centered */}
                    ...
                    {/* Card number positioned just above second card start */}
                    <div className="absolute left-5 right-5 top-[68%] font-semibold tracking-widest text-lg">
              ...
              {cards[1] && (
                <div className="absolute left-4 pr-4 right-0 top-[50%]  overflow-hidden  z-50" style={{ transform: 'scaleY(0.75)', transformOrigin: 'top left' }}>
                  <img src="/icons/Effect.png" alt="Card" className="block w-full h-auto" />
